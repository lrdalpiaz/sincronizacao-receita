...
/**
 * Objeto de domínio que representa uma conta, lida do arquivo CSV.
 */
public class Account {
     ...
     * Num aplicação real, talvez o melhor fosse separa os objetos que representam
     * uma linha do CSV e o objeto de domínio da ReceitaService.
     */
