...
public class AccountCsvParser implements IParser<Account> {
    ...
    public void parse(String csvFilePath, Consumer<Account> consumer) {
        try (Reader reader = Files.newBufferedReader(Paths.get(csvFilePath))) {
            ...
            /*
             * Nesse ponto, poderia ser feito o parser completo do arquivo com o m̩todo csvToBean.parse()
             * Por̩m, como o enunciado aponta para um arquivo com muitas entradas, esse m̩todo ṇo ̩ aconselhado.
             */
